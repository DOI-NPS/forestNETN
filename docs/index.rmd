...
In most cases, you'll import NETN forest data using the csv files in the zipped data package, which can be downloaded on NPS Data Store: <a href="https://irma.nps.gov/DataStore/Reference/Profile/2315861">NETN Forest Data Package</a>.
<p class = 'fxn'>
...
<p class='fxn'>View seedling data for native canopy-forming species only for all plots in SARA</p>
```{r}
...
<p class='fxn'>View soil chemistry data for plots in ACAD from 2007 and later.</p>
```{r}
