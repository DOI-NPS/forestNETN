...
```{r}
rova <- joinMicroSaplings(park = "ROVA", from = 2023, to = 2026)
print_head(rova)
```
...
```{r}
acad_soil <- joinSoilLabData(park = "ACAD", from = 2014)
...
```{r}
acad_stnd <- joinStandDisturbance(park = "ACAD", from = 2023, to = 2026)
